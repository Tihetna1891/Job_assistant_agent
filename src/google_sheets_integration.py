...
if __name__ == "__main__":
    # Set the credentials file and Google Sheet ID (for testing locally, use a fallback)
    json_credentials_file = "credentials.json"  # Local fallback
    spreadsheet_id = "1Wcq6mmLmwWHHxtJN_B2RzZWSzRN-cfJkGjiLzDpm0ys"
    sheet_name = "Sheet1"
